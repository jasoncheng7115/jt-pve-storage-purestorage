...
**[English](README.md)** | **[繁體中文](README_zh-TW.md)** | **[線上文件](https://jasoncheng7115.github.io/jt-pve-storage-purestorage/?lang=zh)**
...
3. **安裝新套件**:
   ```
   dpkg -i jt-pve-storage-purestorage_1.1.19-1_all.deb
   ```
...
apt install ./jt-pve-storage-purestorage_1.1.19-1_all.deb
```
